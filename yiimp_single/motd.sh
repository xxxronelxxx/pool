...
cd "$HOME/Yiimpoolv2/yiimp_single/ubuntu/etc/update-motd.d"
...
sudo cp -r "$HOME/Yiimpoolv2/yiimp_single/ubuntu/screens" /usr/bin/
sudo chmod +x /usr/bin/screens
sudo cp -r "$HOME/Yiimpoolv2/yiimp_single/ubuntu/stratum" /usr/bin/
